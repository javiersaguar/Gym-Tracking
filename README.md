...
src/
  ...
  screens/         Hoy · Entreno · Resumen · Progreso · Historial · Rutina · Ajustes
scripts/
...
Negro, blanco y azul, y nada más. El blanco es la acción principal y el azul el único acento; verde,
ámbar y rojo están reservados para estado (récord, atención, peligro) y siempre van acompañados de
texto, nunca solos.
...
identidad la lleva la etiqueta, escrita siempre al lado. La rampa azul secuencial del calendario está
validada contra el fondo (lightness monótona, saltos visibles, extremo apagado por encima de 2:1 de
contraste).
